...
<!-- regiBf.css -->
<link rel="stylesheet" type="text/css" href="css/regiBf.css">
...
<script type="text/javascript" src="js/clickcr.js"></script>
...
<body>
 ...
 <!-- 약관동의 -->
<div class="terms_p" style="margin-left: 10%; margin-right: 10%; margin-top: 10%;">
   <p class="terms_chk_all">
	<span class="input_chk">
	<input type="checkbox" id="chk_all" name="chk_all">
                            <!-- [D] ie7/8에서 checked일때 label에 클래스 on추가해주세요.  -->
	<label for="chk_all"><span class="chk_all_txt">이용약관, 개인정보 수집 및 이용,<br class='m_br'> 위치정보 이용약관(선택)에 모두 동의합니다.</span></label>
    </span>
  </p>
	...
	<span class="input_chk">
		...
		<label for="termsService">Food Sharing 이용약관 동의<span class="terms_necessary">(필수)</span></label>
	</span>
                       <div class="terms_box" tabindex="0" id="divService">
                                    <!-- Food Sharing 이용약관 동의 -->
<div class="article">
    <h3 class="article__title">여러분을 환영합니다.</h3>
    <p class="article__text">
        Food Sharing 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다.
        본 약관은 다양한 Food Sharing 서비스의 이용과 관련하여 Food Sharing 서비스를 제공하는 Food Sharing 주식회사(이하 ‘Food Sharing’)와
        이를 이용하는 Food Sharing 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며,
        아울러 여러분의 Food Sharing 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
    </p>
    <p class="article__text">
        Food Sharing 서비스를 이용하시거나 Food Sharing 서비스 회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영 정책을 확인하거나 동의하게 되므로,
...
<div class="article">
    ...
    <p class="article__text">
        Food Sharing 서비스에는 기본적으로 본 약관이 적용됩니다만 Food Sharing가 다양한 서비스를 제공하는 과정에서 부득이 본 약관 외 별도의 약관, 운영정책 등을 적용하는 경우(예, Food Sharing페이, V LIVE 등)가 있습니다.
        그리고 Food Sharing 계열사가 제공하는 특정 서비스의 경우에도(예, LINE, SNOW등) 해당 운영 회사가 정한 고유의 약관, 운영정책 등이 적용될 수 있습니다.
        이러한 내용은 각각의 해당 서비스 초기 화면에서 확인해 주시기 바랍니다.
    </p>
</div>
<div class="article">
    <h3 class="article__title">회원으로 가입하시면 Food Sharing 서비스를 보다 편리하게 이용할 수 있습니다.</h3>
    <p class="article__text">
    ...
    <p class="article__text">
        ...
        멤버들의 단체회원 계정 로그인 방법 및 이를 통한 게시물 게재 등 Food Sharing 서비스 이용을 관리(게시물 삭제 포함)할 수 있습니다.
...
<div class="article">
    ...
    <p class="article__text">
        Food Sharing는 여러분이 게재한 게시물이 Food Sharing 서비스를 통해 다른 이용자들에게 전달되어 우리 모두의 삶을 더욱 풍요롭게 해줄 것을 기대합니다.
        게시물은 여러분이 타인 또는 자신이 보게 할 목적으로 Food Sharing 서비스 상에 게재한 부호, 문자, 음성, 음향, 그림, 사진, 동영상, 링크 등으로
        구성된 각종 콘텐츠 자체 또는 파일을 말합니다.
    </p>
    <p class="article__text">
        Food Sharing는 여러분의 생각과 감정이 표현된 콘텐츠를 소중히 보호할 것을 약속 드립니다.
        여러분이 제작하여 게재한 게시물에 대한 지식재산권 등의 권리는 당연히 여러분에게 있습니다.
    </p>
    <p class="article__text">
        한편, Food Sharing 서비스를 통해 여러분이 게재한 게시물을 적법하게 제공하려면 해당 콘텐츠에 대한 저장, 복제, 수정, 공중 송신, 전시, 배포,
        2차적 저작물 작성(단, 번역에 한함) 등의 이용 권한(기한과 지역 제한에 정함이 없으며, 별도 대가 지급이 없는 라이선스)이 필요합니다.<br>
        게시물 게재로 여러분은 Food Sharing에게 그러한 권한을 부여하게 되므로, 여러분은 이에 필요한 권리를 보유하고 있어야 합니다.
    </p>
    <p class="article__text">
        Food Sharing는 여러분이 부여해 주신 콘텐츠 이용 권한을 저작권법 등 관련 법령에서 정하는 바에 따라 Food Sharing 서비스 내 노출, 서비스 홍보를 위한 활용,
    ...
    <p class="article__text">
        또한 여러분이 제공한 소중한 콘텐츠는 Food Sharing 서비스를 개선하고 새로운 Food Sharing 서비스를 제공하기 위해 인공지능 분야 기술 등의 연구 개발 목적으로 Food Sharing 및 Food Sharing 계열사에서 사용될 수 있습니다.
        Food Sharing는 지속적인 연구 개발을 통해 여러분께 좀 더 편리하고 유용한 서비스를 제공해 드릴 수 있도록 최선을 다하겠습니다.
    </p>
    <p class="article__text">
        Food Sharing는 여러분이 자신이 제공한 콘텐츠에 대한 Food Sharing 또는 다른 이용자들의 이용 또는 접근을 보다 쉽게 관리할 수 있도록 다양한 수단을 제공하기 위해 노력하고 있습니다.
        여러분은 Food Sharing 서비스 내에 콘텐츠 삭제, 비공개 등의 관리기능이 제공되는 경우 이를 통해 직접 타인의 이용 또는 접근을 통제할 수 있고,
        고객센터를 통해서도 콘텐츠의 삭제, 비공개, 검색결과 제외 등의 조치를 요청할 수 있습니다.<br>
        다만, 일부 Food Sharing 서비스의 경우 삭제, 비공개 등의 처리가 어려울 수 있으며,
...
<div class="article">
    <h3 class="article__title">Food Sharing에서 제공하는 다양한 포인트를 요긴하게 활용해 보세요.</h3>
    <p class="article__text">
        Food Sharing는 여러분이 Food Sharing 서비스를 효율적으로 이용할 수 있도록 포인트를 부여하고 있습니다.
        포인트는 여러분의 일정한 Food Sharing 서비스 이용과 연동하여 Food Sharing가 임의로 책정하거나 조정하여 지급하는 일정한 계산 단위를 갖는 서비스 상의
        가상 데이터를 말합니다. 포인트는 재산적 가치가 없기 때문에 금전으로 환불 또는 전환할 수 없지만,
        포인트의 많고 적음에 따라 여러분의 Food Sharing 서비스 이용에 영향을 주는 경우가 있으므로 경우에 따라 적절히 활용해 보세요.
    </p>
    <p class="article__text">
        Food Sharing는 Food Sharing 서비스의 효율적 이용을 지원하거나 서비스 운영을 개선하기 위해 필요한 경우 사전에 여러분께 안내 드린 후
        부득이 포인트의 일부 또는 전부를 조정할 수 있습니다.
        그리고 포인트는 Food Sharing가 정한 기간에 따라 주기적으로 소멸할 수도 있으니 포인트가 부여되는 Food Sharing 서비스 이용 시 유의해 주시기 바랍니다.
    </p>
</div>
<div class="article">
    <h3 class="article__title">Food Sharing 서비스 이용과 관련하여 몇 가지 주의사항이 있습니다.</h3>
    <p class="article__text">
        Food Sharing는 여러분이 Food Sharing 서비스를 자유롭고 편리하게 이용할 수 있도록 최선을 다하고 있습니다.
        다만, 여러분이 Food Sharing 서비스를 보다 안전하게 이용하고 Food Sharing 서비스에서 여러분과 타인의 권리가 서로 존중되고 보호받으려면
        여러분의 도움과 협조가 필요합니다. 여러분의 안전한 서비스 이용과 권리 보호를 위해 부득이 아래와 같은 경우
        여러분의 게시물 게재나 Food Sharing 서비스 이용이 제한될 수 있으므로, 이에 대한 확인 및 준수를 요청 드립니다.
    </p>
    <ul class="article__text">
        ...
        <li class="article__text__list">
            자동화된 수단을 활용하는 등 Food Sharing 서비스의 기능을 비정상적으로 이용하여 게재된 게시물, Food Sharing 각 개별 서비스의 제공 취지와
            부합하지 않는 내용의 게시물은 다른 이용자들의 정상적인 Food Sharing 서비스 이용에 불편을 초래하고 더 나아가 Food Sharing의 원활한 서비스 제공을 방해하므로 역시 제한될 수 있습니다.
            기타 제한되는 게시물에 관한 상세한 내용은 <em>게시물 운영정책</em> 및 각 개별 서비스에서의 약관, 운영정책 등을 참고해 주시기 바랍니다.
        </li>
        <li class="article__text__list">
													<span class="article__text">Food Sharing의 사전 허락 없이 자동화된 수단(예: 매크로 프로그램, 로봇(봇), 스파이더, 스크래퍼 등)을 이용하여 Food Sharing 서비스 회원으로 가입을 시도 또는 가입하거나,
													Food Sharing 서비스에 로그인을 시도 또는 로그인하거나, Food Sharing 서비스 상에 게시물을 게재하거나, Food Sharing 서비스를 통해 커뮤니케이션하거나(예: 전자메일, 쪽지 등),</span>
            Food Sharing 서비스에 게재된 회원의 아이디(ID), 게시물 등을 수집하거나, Food Sharing 검색 서비스에서 특정 질의어로 검색하거나
            혹은 그 검색결과에서 특정 검색결과를 선택(이른바 ‘클릭’)하는 등 <span class="article__text">이용자(사람)의 실제 이용을 전제로 하는 Food Sharing 서비스의 제공 취지에 부합하지 않는 방식으로
													Food Sharing 서비스를 이용하거나 이와 같은 Food Sharing 서비스에 대한 어뷰징(남용) 행위를 막기 위한 Food Sharing의 기술적 조치를 무력화하려는 일체의 행위</span>(예: IP를 지속적으로 바꿔가며 접속하는 행위,
            Captcha를 외부 솔루션 등을 통해 우회하거나 무력화 하는 행위 등)를 시도해서는 안 됩니다.
        </li>
        <li class="article__text__list">
													<span class="article__text">Food Sharing의 동의 없이 자동화된 수단에 의해 Food Sharing 서비스 상에 광고가 게재되는 영역 또는 그 밖의 영역에 부호, 문자, 음성, 음향, 그림, 사진, 동영상, 링크 등으로
													구성된 각종 콘텐츠 자체 또는 파일을 삽입</span>해서는 안 됩니다. 또한, Food Sharing 서비스 또는 이에 포함된 소프트웨어를 복사, 수정할 수 없으며,
            이를 판매, 양도, 대여 또는 담보로 제공하거나 타인에게 그 이용을 허락해서는 안 됩니다. Food Sharing 서비스에 포함된 소프트웨어를 역 설계, 소스코드 추출 시도,
            복제, 분해, 모방, 기타 변형하는 등의 행위도 금지됩니다(다만, 오픈소스에 해당되는 경우 그 자체 조건에 따릅니다).
            <span class="article__text">그 밖에 바이러스나 기타 악성 코드를 업로드하거나 Food Sharing 서비스의 원활한 운영을 방해할 목적으로 서비스 기능을 비정상적으로 이용하는 행위</span> 역시 금지됩니다.
        </li>
    </ul>
    <p class="article__text">
        Food Sharing는 본 약관의 범위 내에서 게시물 운영정책, 각 개별 서비스에서의 약관 또는 운영정책, 각 서비스 상의 안내, 공지사항, 고객센터 도움말 등을 두어,
...
<div class="article">
    ...
    <p class="article__text">
        Food Sharing는 다양한 정보와 의견이 담긴 여러분의 콘텐츠를 소중히 다룰 것을 약속 드립니다만, 여러분이 게재한 게시물이 관련 법령, 본 약관, 게시물 운영정책,
        각 개별 서비스에서의 약관, 운영정책 등에 위배되는 경우, 부득이 이를 비공개 또는 삭제 처리하거나 게재를 거부할 수 있습니다.
        다만, 이것이 Food Sharing가 모든 콘텐츠를 검토할 의무가 있다는 것을 의미하지는 않습니다.
    </p>
    <p class="article__text">
        또한 여러분이 관련 법령, 본 약관, 계정 및 게시물 운영정책, 각 개별 서비스에서의 약관, 운영정책 등을 준수하지 않을 경우,
        Food Sharing는 여러분의 관련 행위 내용을 확인할 수 있으며, 그 확인 결과에 따라 Food Sharing 서비스 이용에 대한 주의를 당부하거나,
        Food Sharing 서비스 이용을 일부 또는 전부, 일시 또는 영구히 정지시키는 등 그 이용을 제한할 수 있습니다.
        한편, 이러한 이용 제한에도 불구하고 더 이상 Food Sharing 서비스 이용계약의 온전한 유지를 기대하기 어려운 경우엔 부득이 여러분과의 이용계약을 해지할 수 있습니다.
    </p>
    <p class="article__text">
...
<div class="article">
    <h3 class="article__title">Food Sharing의 잘못은 Food Sharing가 책임집니다.</h3>
    <p class="article__text">
        Food Sharing는 여러분이 Food Sharing 서비스를 이용함에 있어 Food Sharing의 고의 또는 과실로 인하여 손해를 입게 될 경우 관련 법령에 따라 여러분의 손해를 배상합니다.
        다만, 천재지변 또는 이에 준하는 불가항력으로 인하여 Food Sharing가 서비스를 제공할 수 없거나 이용자의 고의 또는 과실로 인하여 서비스를 이용할 수 없어
        발생한 손해에 대해서 Food Sharing는 책임을 부담하지 않습니다.
    </p>
    <p class="article__text">
        그리고 Food Sharing가 손해배상책임을 부담하는 경우에도 통상적으로 예견이 불가능하거나 특별한 사정으로 인한 특별 손해 또는 간접 손해,
        기타 징벌적 손해에 대해서는 관련 법령에 특별한 규정이 없는 한 책임을 부담하지 않습니다.
    </p>
    <p class="article__text">
        한편, Food Sharing 서비스를 매개로 한 여러분과 다른 회원 간 또는 여러분과 비회원 간의 의견 교환,
        거래 등에서 발생한 손해나 여러분이 서비스 상에 게재된 타인의 게시물 등의 콘텐츠를 신뢰함으로써 발생한 손해에 대해서도
        Food Sharing는 특별한 사정이 없는 한 이에 대해 책임을 부담하지 않습니다.
    </p>
</div>
<div class="article">
    <h3 class="article__title">언제든지 Food Sharing 서비스 이용계약을 해지하실 수 있습니다.</h3>
    <p class="article__text">
        Food Sharing에게는 참 안타까운 일입니다만, 회원은 언제든지 Food Sharing 서비스 이용계약 해지를 신청하여 회원에서 탈퇴할 수 있으며,
        이 경우 Food Sharing는 관련 법령 등이 정하는 바에 따라 이를 지체 없이 처리하겠습니다.
    </p>
    <p class="article__text">
        Food Sharing 서비스 이용계약이 해지되면, 관련 법령 및 개인정보처리방침에 따라 Food Sharing가 해당 회원의 정보를 보유할 수 있는 경우를 제외하고,
...
<div class="article">
    <h3 class="article__title">일부 Food Sharing 서비스에는 광고가 포함되어 있습니다.</h3>
    <p class="article__text">
        여러분이 다양한 Food Sharing 서비스를 이용하다 보면 간혹 일부 개별 서비스에 광고가 포함된 경우가 있습니다.
        Food Sharing 서비스를 이용하면서 발생할 수 있는 데이터 통신요금은 가입하신 통신사업자와의 이용계약에 따라 여러분이 부담하며,
        포함된 광고 열람으로 인해 추가적으로 발생하는 비용 역시 여러분이 부담합니다.
    </p>
    <p class="article__text">
												<span class="article__text">원하는 Food Sharing 서비스를 이용하기 위해 원하지 않는 광고를 봐야 하는 경우가 있습니다.
												이는 여러분에게 제공하는 다양한 Food Sharing 서비스를 원칙적으로 무료로 제공할 수 있게 해주는 데 기여하며,
												더 나아가 Food Sharing가 연구 개발에 투자하여 더 나은 서비스를 제공할 수 있는 기반이 됩니다.
												최근 타사의 일부 서비스들이 광고 없는 서비스 이용을 강조하며 주된 서비스를 유료로 제공하고 있는 관행이 이를 뒷받침합니다.
												</span>
    </p>
    <p class="article__text">
        Food Sharing는 여러분의 본의 아닌 불편이나 부담이 최소화될 수 있는 방법에 대해 항상 고민하고 개선해 나가겠습니다.
    </p>
</div>
<div class="article">
    <h3 class="article__title">서비스 중단 또는 변경 시 꼭 알려드리겠습니다.</h3>
    <p class="article__text">
        Food Sharing는 연중 무휴, 1일 24시간 안정적으로 서비스를 제공하기 위해 최선을 다하고 있습니다만, 컴퓨터, 서버 등 정보통신설비의 보수점검,
        교체 또는 고장, 통신두절 등 운영상 상당한 이유가 있는 경우 부득이 서비스의 전부 또는 일부를 중단할 수 있습니다.
    </p>
    <p class="article__text">
        한편, Food Sharing는 서비스 운영 또는 개선을 위해 상당한 필요성이 있는 경우 서비스의 전부 또는 일부를 수정, 변경 또는 종료할 수 있습니다.
        무료로 제공되는 서비스의 전부 또는 일부를 수정, 변경 또는 종료하게 된 경우 관련 법령에 특별한 규정이 없는 한 별도의 보상을 하지 않습니다.
    </p>
    <p class="article__text">
        이 경우 Food Sharing는 예측 가능한 경우 상당기간 전에 이를 안내하며, 만약 예측 불가능한 경우라면 사후 지체 없이 상세히 설명하고 안내 드리겠습니다.
...
<div class="article">
    ...
    <p class="article__text">
        Food Sharing는 서비스 이용에 필요한 주요사항을 적시에 잘 안내해 드릴 수 있도록 힘쓰겠습니다.
        회원에게 통지를 하는 경우 전자메일, 서비스 내 알림 또는 기타 적절한 전자적 수단을 통해 개별적으로 알려 드릴 것이며,
        다만 회원 전체에 대한 통지가 필요할 경우엔 7일 이상 <a href="https://www.FoodSharing.com" target="_blank">www.FoodSharing.com</a>을 비롯한 Food Sharing 도메인의 웹사이트 및 응용프로그램(어플리케이션, 앱)
        초기 화면 또는 공지사항 등에 관련 내용을 게시하도록 하겠습니다.
    </p>
    <p class="article__text">
        Food Sharing는 여러분의 소중한 의견에 귀 기울이겠습니다. 여러분은 언제든지 고객센터를 통해 서비스 이용과 관련된 의견이나 개선사항을 전달할 수 있으며,
        Food Sharing는 합리적 범위 내에서 가능한 그 처리과정 및 결과를 여러분께 전달할 수 있도록 하겠습니다.
    </p>
</div>
<div class="article">
    <h3 class="article__title">여러분이 쉽게 알 수 있도록 약관 및 운영정책을 게시하며 사전 공지 후 개정합니다.</h3>
    <p class="article__text">
        Food Sharing는 본 약관의 내용을 여러분이 쉽게 확인할 수 있도록 서비스 초기 화면에 게시하고 있습니다.
    </p>
    <p class="article__text">
        Food Sharing는 수시로 본 약관, 계정 및 게시물 운영정책을 개정할 수 있습니다만, 관련 법령을 위배하지 않는 범위 내에서 개정할 것이며,
    ...
    <p class="article__text">
        Food Sharing는 변경된 약관을 게시한 날로부터 효력이 발생되는 날까지 약관 변경에 대한 여러분의 의견을 기다립니다.
        위 기간이 지나도록 여러분의 의견이 Food Sharing에 접수되지 않으면, 여러분이 변경된 약관에 따라 서비스를 이용하는 데에 동의하는 것으로 간주됩니다.
        Food Sharing로서는 매우 안타까운 일이지만, 여러분이 변경된 약관에 동의하지 않는 경우 변경된 약관의 적용을 받는 해당 서비스의 제공이 더 이상 불가능하게 될 수 있습니다.
    </p>
    <p class="article__text">
        Food Sharing 서비스에는 기본적으로 본 약관이 적용됩니다만, 부득이 각 개별 서비스의 고유한 특성을 반영하기 위해 본 약관 외 별도의 약관,
    ...
    <p class="article__text">
        본 약관은 한국어를 정본으로 합니다. 본 약관 또는 Food Sharing 서비스와 관련된 여러분과 Food Sharing와의 관계에는 대한민국의 법령이 적용됩니다.
        그리고 본 약관 또는 Food Sharing 서비스와 관련하여 여러분과 Food Sharing 사이에 분쟁이 발생할 경우,
    ...
    <p class="article__text">
        Food Sharing 서비스와 관련하여 궁금하신 사항이 있으시면 <a href="https://help.FoodSharing.com/" target="_blank">고객센터</a>(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.
    </p>
</div>                                </div>
                            </li>
                            <li class="terms_bx">
									<span class="input_chk">
                                        ...
                                        <!-- <a href="#" id="termForChild" class="easy_guide" role="button"><span class="txt">어린이용 안내</span></a> -->
									</span>
                                <div class="terms_box" tabindex="0" id="divPrivacy">
                                    <!-- 개인정보 수집 및 이용에 대한 안내 -->
<div class="policy_summary">
    <p class="policy_summary__text">정보통신망법 규정에 따라 Food Sharing에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.</p>
</div>
<div class="article">
    <h3 class="article__title">1. 수집하는 개인정보</h3>
    <p class="article__text">이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 Food Sharing 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, Food Sharing는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.</p>
    <div class="clause">
        <h4 class="clause__title">회원가입 시점에 Food Sharing가 이용자로부터 수집하는 개인정보는 아래와 같습니다.</h4>
        <ul class="sections">
        ...
        <p class="clause__text">FoodSharing 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.</p>
        ...
        <p class="clause__text">
            ...
            Food Sharing 위치기반서비스 이용 시 수집·저장되는 위치정보의 이용 등에 대한 자세한 사항은 ‘Food Sharing 위치정보 이용약관’에서 규정하고 있습니다.
        </p>
    </div>
</div>
<div class="article">
    <h3 class="article__title">2. 수집한 개인정보의 이용</h3>
    <p class="article__text">Food Sharing 및 Food Sharing 관련 제반 서비스(모바일 웹/앱 포함)의 회원관리, 서비스 개발・제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.</p>
    <ul class="sections">
        ...
        <li class="sections__section">- 법령 및 Food Sharing 이용약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재, 계정도용 및 부정거래 방지, 약관 개정 등의 고지사항 전달, 분쟁조정을 위한 기록 보존, 민원처리 등 이용자 보호 및 서비스 운영을 위하여 개인정보를 이용합니다.</li>
...
<div class="article">
    ...
    <div class="clause">
        ...
        <p class="clause__text">부정가입 및 징계기록 등의 부정이용기록은 부정 가입 및 이용 방지를 위하여 수집 시점으로부터 6개월간 보관하고 파기하고 있습니다. 부정이용기록 내 개인정보는 가입인증 휴대폰 번호(만 14세 미만 회원의 경우 법정대리인 DI)가 있습니다.<br>
            결제도용, 불법할인대출(일명 '카드깡') 등 관련 법령 및 이용약관을 위반하는 Food Sharing페이의 부정거래기록(아이디, 이름, 휴대전화번호, 배송지 주소, IP주소, 쿠키, 기기정보)은 부정거래 방지 및 다른 선량한 이용자의 보호, 안전한 거래 환경 보장을 위하여 수집 시점으로부터 3년간 보관하고 파기합니다.<br>
    ...
    <div class="clause">
        <h4 class="clause__title">전자상거래 등에서의 소비자 보호에 관한 법률, 전자금융거래법, 통신비밀보호법 등 법령에서 일정기간 정보의 보관을 규정하는 경우는 아래와 같습니다. Food Sharing는 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른 목적으로는 절대 이용하지 않습니다.</h4>
        <ul class="sections">
        ...
        <p class="clause__text">회원탈퇴, 서비스 종료, 이용자에게 동의받은 개인정보 보유기간의 도래와 같이 개인정보의 수집 및 이용목적이 달성된 개인정보는 재생이 불가능한 방법으로 파기하고 있습니다.
            ...
            참고로 Food Sharing는 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.
            단, Food Sharing페이의 간편결제수단은 분리 보관하지 않고, 삭제합니다.
        </p>
    </div>
</div>                                </div>
                            </li>
                            <li class="terms_bx">
                                ...
                                <div class="terms_box" id="divLocation">
                                    <!-- 위치정보 이용약관 동의 -->
<div class="policy_summary">
								<p class="policy_summary__text">위치정보 이용약관에 동의하시면, <strong>위치를 활용한 광고 정보 수신</strong> 등을 포함하는 Food Sharing 위치기반 서비스를 이용할 수 있습니다.</p><br>
							</div>
							<div class="article">
								<h3 class="article__title">제 1 조 (목적)</h3>
								<p class="article__text">이 약관은 Food Sharing 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
							</div>
							<div class="article">
							...
							<div class="article">
								...
								<div class="clause">
									...
									<ul class="sections">
										...
										<li class="sections__section">전화번호 : 1588-3820</li>
										<li class="sections__section">이메일 주소 : privacy@FoodSharing.com</li>
									</ul>
								</div>
							</div>                                </div>
                        ...
                        <span class="error" id="agreeMsg" style="display:none">Food Sharing 이용약관과 개인정보 수집 및 이용에 대한 안내 모두 동의해주세요.</span>
                    </div>
